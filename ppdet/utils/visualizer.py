...
def draw_bbox(image, im_id, catid2name, bboxes, threshold, save_true=False):
    """
    Draw bbox on image
    """
    # print('bboxes', bboxes)
...
def save_result(save_path, results, catid2name, threshold, save_true=False):
    """
    save result as txt
    """
